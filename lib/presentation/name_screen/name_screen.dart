                                                                      ...
                                                                      child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.end, children: [
                                                                        Align(
                                                                            ...
                                                                            child: Padding(
                                                                                ...
                                                                                child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                                                                                  Padding(padding: getPadding(top: 12, bottom: 6), child: Text("HRTBT", overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtGilroyBlackItalic28.copyWith(letterSpacing: getHorizontalSize(0.56)))),
                                                                                  CustomImageView(imagePath: ImageConstant.imgChip, height: getVerticalSize(54.00), width: getHorizontalSize(44.00), margin: getMargin(left: 43))
                                                                                ]))),
                                                                        Container(
                                                                            width:
                                                                                getHorizontalSize(91.00),
                                                                            margin: getMargin(left: 14, top: 22),
                                                                        ...
                                                                        Padding(
                                                                            padding:
                                                                                getPadding(top: 47),
                                                                            child: Row(children: [
                                                                              CustomImageView(imagePath: ImageConstant.imgVector155x114, height: getVerticalSize(155.00), width: getHorizontalSize(114.00), radius: BorderRadius.circular(getHorizontalSize(17.00))),
                                                                              Padding(
                                                                                  padding: getPadding(left: 23, top: 73, bottom: 15),
                                                                                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.start, children: [
                                                                                    ...
                                                                                    CustomImageView(imagePath: ImageConstant.imgMastercard, height: getVerticalSize(30.00), width: getHorizontalSize(49.00), alignment: Alignment.center, margin: getMargin(top: 16))
                                                                                  ]))
                                                                            ]))
                                                                      ]))))
                                                    ]))),
                                        Align(
                                            ...
                                            child: Padding(
                                                ...
                                                child: OutlineGradientButton(
                                                    ...
                                                    child: CustomButton(width: 145, text: "Continue", margin: getMargin(bottom: 17), variant: ButtonVariant.Outline, shape: ButtonShape.RoundedBorder10, padding: ButtonPadding.PaddingAll11, fontStyle: ButtonFontStyle.RalewayExtraBold16, onTap: () => onTapContinue(context), alignment: Alignment.bottomCenter))))
                                      ]))))
                    ]))));
  }
