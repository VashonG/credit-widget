...
class AppNavigationScreen extends StatelessWidget {
  ...
  onTapDisclosure(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.disclosureScreen);
  }

  onTapCreditLimit(BuildContext context) {
  ...
  onTapPersonal(BuildContext context) {
